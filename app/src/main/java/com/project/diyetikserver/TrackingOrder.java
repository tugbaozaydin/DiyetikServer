...
import com.project.diyetikserver.Common.DirectionJSONParser;
...
public class TrackingOrder extends FragmentActivity implements OnMapReadyCallback,
    ...
    private final static int PLAY_SERVİCES_RESOLUTION_REQUEST=1000;
    private final static int LOCATİON_PERMISSION_REQUEST=1000;
    ...
    private boolean checkPlayServices() {
        ...
        if(resultCode != ConnectionResult.SUCCESS){
            if(GooglePlayServicesUtil.isUserRecoverableError(resultCode)){
                GooglePlayServicesUtil.getErrorDialog(resultCode,this,PLAY_SERVİCES_RESOLUTION_REQUEST).show();
            }
            else{
                Toast.makeText(this,"İşlemi bu cihaz desteklemiyor.", Toast.LENGTH_SHORT).show();
                finish();
            }
            return false;
        }
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        switch(requestCode){
            case LOCATİON_PERMISSION_REQUEST:
